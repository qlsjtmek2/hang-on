...
describe('Button Component', () => {
  it('renders with title', () => {
    const { getByText } = render(<Button title="테스트 버튼" onPress={() => {}} />);
    expect(getByText('테스트 버튼')).toBeTruthy();
  });

  it('calls onPress when pressed', () => {
    const onPress = jest.fn();
    const { getByText } = render(<Button title="테스트 버튼" onPress={onPress} />);
    fireEvent.press(getByText('테스트 버튼'));
    expect(onPress).toHaveBeenCalledTimes(1);
  });

  it('renders primary variant by default', () => {
    const { getByRole } = render(<Button title="테스트 버튼" onPress={() => {}} />);
  ...
  it('renders ghost variant', () => {
    const { getByRole } = render(<Button title="테스트 버튼" onPress={() => {}} variant="ghost" />);
    const button = getByRole('button');
    expect(button.props.style).toBeTruthy();
  });
  ...
  it('disables button when disabled prop is true', () => {
    const onPress = jest.fn();
    const { getByRole } = render(<Button title="테스트 버튼" onPress={onPress} disabled />);
    const button = getByRole('button');
  ...
  it('applies fullWidth style', () => {
    const { getByRole } = render(<Button title="Full Width" onPress={() => {}} fullWidth />);
    const button = getByRole('button');
    expect(button.props.style).toBeTruthy();
  });
  ...
  it('uses custom accessibility label', () => {
    const { getByLabelText } = render(
      <Button title="버튼" onPress={() => {}} accessibilityLabel="커스텀 라벨" />,
    );
  ...
  it('uses custom accessibility hint', () => {
    const { getByRole } = render(
      <Button title="버튼" onPress={() => {}} accessibilityHint="커스텀 힌트" />,
    );
    const button = getByRole('button');
  ...
  it('applies custom styles', () => {
    ...
    const { getByRole } = render(
      <Button title="Custom" onPress={() => {}} style={customStyle} textStyle={customTextStyle} />,
    );
