...
- [x] 그리고 오른쪽 위에 알람 아이콘이 있고, 코멘트나 공감을 받으면 알림을 뜨도록. (접속 유도)

- [x] 토스트 메세지

- [x] 누군가와 함께 스크롤을 쎼게하면 한번에 2개 넘어가는 거 수정
- [x] 설정 창
- [x] 온보딩
...
**Week 2: 사용자 경험 강화** ✅ 완료 5. ✅ 스켈레톤 UI (10.2) 6. ✅ 진행 상황 인디케이터 (10.3) 7. ✅ 자동 임시 저장 (10.4)
